...
void HelloWorld::addEdges() {
    ...
    auto physicsBody = PhysicsBody::createEdgeBox(visibleSize,PHYSICSBODY_MATERIAL_DEFAULT, 3);
...
void HelloWorld::addBall(int positionX, int positionY) {
    auto ball = Sprite::create("ball.png");
    ball->setPhysicsBody(PhysicsBody::createBox(ball->getContentSize()));
    ball->setPosition(Vec2(positionX, positionY));
    addChild(ball);
}
